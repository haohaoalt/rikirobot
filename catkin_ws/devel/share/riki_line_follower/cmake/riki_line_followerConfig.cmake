...
if("TRUE" STREQUAL "TRUE")
  set(riki_line_follower_SOURCE_PREFIX /home/haopi3/rikirobot/catkin_ws/src/rikirobot_project/riki_line_follower)
  set(riki_line_follower_DEVEL_PREFIX /home/haopi3/rikirobot/catkin_ws/devel)
  ...
  set(riki_line_follower_INSTALL_PREFIX /home/haopi3/rikirobot/catkin_ws/install)
...
if(NOT "/home/haopi3/rikirobot/catkin_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'riki_line_follower' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/haopi3/rikirobot/catkin_ws/src/rikirobot_project/riki_line_follower/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT riki_line_follower_NUM_DUMMY_TARGETS)
      set(riki_line_follower_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::riki_line_follower::wrapped-linker-option${riki_line_follower_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR riki_line_follower_NUM_DUMMY_TARGETS "${riki_line_follower_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::riki_line_follower::wrapped-linker-option${riki_line_follower_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND riki_line_follower_LIBRARIES "${interface_target_name}")
