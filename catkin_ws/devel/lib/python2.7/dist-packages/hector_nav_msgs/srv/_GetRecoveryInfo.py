...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.trajectory_radius_entry_pose_to_req_pose.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.radius_entry_pose.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.req_pose.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
