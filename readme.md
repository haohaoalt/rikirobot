...
马健、钱洲同、陈星、姚远、赵晨希、圣传柳、叶成岩、刘泽亮、张昊(testgit)

**课程安排：**

| 日期  | 上午（8:30-12:30） | 下午（12:30-18:00） | 晚上（18:00-20:30） |
| ----- | :----------------: | :-----------------: | :-----------------: |
| 11.12 |     马健、陈星     |     姚远、陈星      |        姚远         |
| 11.13 |   钱洲同、赵晨希   |   赵晨希、圣传柳    |       圣传柳        |
| 11.19 |   叶成岩、刘泽亮   |    叶成岩、陈星     |        陈星         |
| 11.20 |   刘泽亮、圣传柳   |    赵晨希、姚远     |       刘泽亮        |
| 11.26 |    马健、叶成岩    |   钱洲同、圣传柳    |       钱洲同        |
| 11.27 |     马健、姚远     |    考核全员参与     |    考核全员参与     |
...
| **实验报告**       | 30'    | 待确定，但截止时间基本确定在11月30日。~~电子版报告由班长汇总后提交至majian990520@163.com，格式为：姓名+学号；纸质版由班长收齐后交至行政楼425；纸质与电子版报告需于11月30日17：00前提交。~~ |
...
两块亚克力板（其中一块为底盘）、两个轮胎和电机编码器套装、两个小辅助轮、稳压模块、树莓派、stm32、电机驱动与面包板、IMU一个、雷达一个、两个小开关、杜邦线若干、USB线若干、12V电池一块、六角铜柱与螺丝螺帽若干。
