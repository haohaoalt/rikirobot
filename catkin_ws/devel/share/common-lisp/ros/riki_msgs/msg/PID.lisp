...
(cl:defmethod cl:initialize-instance :after ((m <PID>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PID)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name riki_msgs-msg:<PID> is deprecated: use riki_msgs-msg:PID instead.")))

(cl:ensure-generic-function 'p-val :lambda-list '(m))
(cl:defmethod p-val ((m <PID>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader riki_msgs-msg:p-val is deprecated.  Use riki_msgs-msg:p instead.")
  (p m))

(cl:ensure-generic-function 'd-val :lambda-list '(m))
(cl:defmethod d-val ((m <PID>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader riki_msgs-msg:d-val is deprecated.  Use riki_msgs-msg:d instead.")
  (d m))

(cl:ensure-generic-function 'i-val :lambda-list '(m))
(cl:defmethod i-val ((m <PID>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader riki_msgs-msg:i-val is deprecated.  Use riki_msgs-msg:i instead.")
  (i m))
