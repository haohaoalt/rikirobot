...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MomentArrayStamped>)))
  ...
  (cl:format cl:nil "Header header~%Moment[] moments~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: opencv_apps/Moment~%# spatial moments~%float64 m00~%float64 m10~%float64 m01~%float64 m20~%float64 m11~%float64 m02~%float64 m30~%float64 m21~%float64 m12~%float64 m03~%~%# central moments~%float64 mu20~%float64 mu11~%float64 mu02~%float64 mu30~%float64 mu21~%float64 mu12~%float64 mu03~%~%# central normalized moments~%float64 nu20~%float64 nu11~%float64 nu02~%float64 nu30~%float64 nu21~%float64 nu12~%float64 nu03~%~%# center of mass m10/m00, m01/m00~%Point2D center~%float64 length~%float64 area~%~%================================================================================~%MSG: opencv_apps/Point2D~%float64 x~%float64 y~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MomentArrayStamped)))
  "Returns full string definition for message of type 'MomentArrayStamped"
  (cl:format cl:nil "Header header~%Moment[] moments~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: opencv_apps/Moment~%# spatial moments~%float64 m00~%float64 m10~%float64 m01~%float64 m20~%float64 m11~%float64 m02~%float64 m30~%float64 m21~%float64 m12~%float64 m03~%~%# central moments~%float64 mu20~%float64 mu11~%float64 mu02~%float64 mu30~%float64 mu21~%float64 mu12~%float64 mu03~%~%# central normalized moments~%float64 nu20~%float64 nu11~%float64 nu02~%float64 nu30~%float64 nu21~%float64 nu12~%float64 nu03~%~%# center of mass m10/m00, m01/m00~%Point2D center~%float64 length~%float64 area~%~%================================================================================~%MSG: opencv_apps/Point2D~%float64 x~%float64 y~%~%~%~%"))
