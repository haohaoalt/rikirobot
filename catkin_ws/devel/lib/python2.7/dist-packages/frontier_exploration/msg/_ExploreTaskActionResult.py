...
"""autogenerated by genpy from frontier_exploration/ExploreTaskActionResult.msg. Do not edit."""
import codecs
import sys
...
class ExploreTaskActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "frontier_exploration/ExploreTaskActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','frontier_exploration/ExploreTaskResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ExploreTaskActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = frontier_exploration.msg.ExploreTaskResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = frontier_exploration.msg.ExploreTaskResult()
