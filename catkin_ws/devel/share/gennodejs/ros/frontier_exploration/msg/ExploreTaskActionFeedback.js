...
class ExploreTaskActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new ExploreTaskFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ExploreTaskFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ExploreTaskActionFeedback(null);
    ...
    data.feedback = ExploreTaskFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += ExploreTaskFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ExploreTaskActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = ExploreTaskFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new ExploreTaskFeedback()
    }
...
module.exports = ExploreTaskActionFeedback;
